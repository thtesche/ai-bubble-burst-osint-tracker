...
def build_system_prompt() -> str:
    ...
    return (
        ...
        "risk assessment.\n\n"
        "IMPORTANT: You MUST start your response with a <thinking> block to "
        "reason about the data before outputting the final report. In this "
        "block, analyze the provided scores and indicators. After the "
        "</thinking> block, output the final structured response in the "
        "requested format.\n\n"
...
def build_user_prompt(
    ...
    prompt_parts.append(
        ...
        "## Risk Evaluation\n"
        f"- **Algorithm Bubble Score:** {bubble_score:.1f}%\n"
        "- **Score Interpretation:** (Qualitatively explain WHY the provided data justifies this score. Do NOT invent a new rating, just explain the calculated score.)\n"
        "- **Confidence Level in Data:** (Low/Medium/High based on data availability/quality)\n"
        ...
        "- **Likelihood of significant correction (>20% drop):** (percentage estimate based on the score)\n\n"
        "## Final Verdict\n"
